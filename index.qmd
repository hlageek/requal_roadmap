...
- [ ] docx/odt text extraction (or as an extension?)
...
- [ ] Standalone Electron installers
  ...
  - [ ] Windows
  - [ ] Linux
- [ ] Extensions via packaged modules
  - [ ] Requal API
    - [ ] Read tables
    - [ ] Write to tables
    - [ ] Some reactivity (e.g. find location in a document)
  - [ ] SDK 
   - [ ] Articles
   - [ ] Template repo
...
- [ ] Segments column in Annotation screen
- [ ] Highlight codes in a segment when part of a selection

## Extensions

- [ ] Wordcloud visualization
- [ ] Code-Categories 2mode network visualization
- [ ] Automated transcription of audio files
- [ ] Export segments via officeR
- [ ] Intercoder metrics